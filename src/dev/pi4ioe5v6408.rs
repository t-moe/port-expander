    ...
    I2C: crate::I2cBus,
{
    ...
    /// - `no_initialize` - If `true` the initial init sequence will not be sent again (useful to keep the config of the pins after a MCU reset)
    pub fn new(i2c: I2C, addr: bool, no_initialize: bool) -> Result<Self, I2C::BusError> {
        Self::with_mutex(i2c, addr, no_initialize)
    }
}
    ...
    M: shared_bus::BusMutex<Bus = Driver<I2C>>,
{
    ...
    pub fn with_mutex(i2c: I2C, addr: bool, no_initialize: bool) -> Result<Self, I2C::BusError> {
...
impl<I2C: crate::I2cBus> Driver<I2C> {
    pub fn new(mut i2c: I2C, addr: bool, no_initialize: bool) -> Result<Self, I2C::BusError> {
...
mod tests {
    ...
    fn pi4ioe5v6408() {
        ...
        let mut pca = super::Pi4ioe5v6408::new(bus.clone(), false, false).unwrap();
    ...
    fn pi4ioe5v6408_no_initialize() {
        ...
        let mut pca = super::Pi4ioe5v6408::new(bus.clone(), true, true).unwrap();
        let pca_pins = pca.split();
